            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
                <div class="col">
                    <div class="card shadow-sm object-fit-contain">
                        <img src="img/hotelroom1.jpeg" height="225" class="object-fit-cover border rounded"
                ...
                <div class="col">
                    <div class="card shadow-sm object-fit-contain">
                        <img src="img/hotelroom4.jpeg" height="225" class="object-fit-cover border rounded"
                            alt="Picture of beatiful hotelroom 4">
                        <div class="card-body">
                ...
                <div class="col">
                    <div class="card shadow-sm object-fit-contain">
                        <img src="img/hotelroom8.jpeg" height="225" class="object-fit-cover border rounded"
                            alt="Picture of beatiful hotelroom 8">
                        <div class="card-body">
                ...
                <div class="col">
                    <div class="card shadow-sm object-fit-contain">
                        <img src="img/hotelroom6.jpeg" height="225" class="object-fit-cover border rounded"
                            alt="Picture of beatiful hotelroom 6">
                        <div class="card-body">
                ...
                <div class="col">
                    <div class="card shadow-sm object-fit-contain">
                        <img src="img/hotelroom2.jpeg" height="225" class="object-fit-cover border rounded"
                            alt="Picture of beatiful hotelroom 2">
                        <div class="card-body">
                ...
                <div class="col">
                    <div class="card shadow-sm object-fit-contain">
                        <img src="img/hotelroom9.jpeg" height="225" class="object-fit-cover border rounded"
                            alt="Picture of beatiful hotelroom 9">
                        <div class="card-body">
